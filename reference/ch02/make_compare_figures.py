...
def main() -> int:
    ...
    figs = [
        ...
        ("fig_2_22", [("interp2 grid 1:0.4:32", OUT / "fig_2_22_interpolation_comparison.png")],
        ...
        ("fig_2_15", [("convolution", OUT / "fig_2_15_convolution.png")], [], 24, "Fig. 2.15 - 3x3 convolution (Eq. 2.15)"),
